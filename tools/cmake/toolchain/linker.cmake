...
function (create_executable EXE_NAME OUTPUT_DIR TEST)
    ...
    elseif(ACS MATCHES "bsa")
        add_custom_command(OUTPUT CPP-LD--${EXE_NAME}${TEST}
                        COMMAND ${CROSS_COMPILE}gcc -E -P -I${ROOT_DIR}/baremetal_app/ -I${ROOT_DIR}/pal/baremetal/target/${TARGET}/common/include -I${ROOT_DIR} ${SCATTER_INPUT_FILE} -o ${SCATTER_OUTPUT_FILE} -DCMAKE_BUILD={CMAKE_BUILD}
                        DEPENDS ${VAL_LIB} ${PAL_LIB} ${TEST_LIB})
        add_custom_target(CPP-LD-${EXE_NAME}${TEST} ALL DEPENDS CPP-LD--${EXE_NAME}${TEST})
    endif()
