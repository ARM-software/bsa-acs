...
void val_mmu_add_mmap(void)
{
    ...
    /* PCIe BAR region */
    val_mmap_add_region(PCIE_BAR64, PCIE_BAR64, 0x1000000, ATTR_RW_DATA | ATTR_NS);
    val_mmap_add_region(PCIE_BAR64_RP, PCIE_BAR64_RP, 0x1000000, ATTR_RW_DATA | ATTR_NS);

    val_mmap_add_region(PCIE_BAR32_P, PCIE_BAR32_P, 0x1000000, ATTR_RW_DATA | ATTR_NS);
    val_mmap_add_region(PCIE_BAR32_NP, PCIE_BAR32_NP, 0x1000000, ATTR_RW_DATA | ATTR_NS);
    val_mmap_add_region(PCIE_BAR32_RP, PCIE_BAR32_RP, 0x1000000, ATTR_RW_DATA | ATTR_NS);
