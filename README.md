...
[![BSA-ACS UEFI Build](https://github.com/ARM-software/bsa-acs/actions/workflows/build-bsa.yml/badge.svg?event=schedule)](https://github.com/ARM-software/bsa-acs/actions/workflows/build-bsa.yml)
