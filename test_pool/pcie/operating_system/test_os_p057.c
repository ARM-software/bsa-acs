...
#define TEST_DESC  "RE_ACS_1 & 2,IE_ACS_1: Check RCiEP, iEP_EP P2P Supp"
...
payload(void)
{
  ...
  for (tbl_index = 0; tbl_index < bdf_tbl_ptr->num_entries; tbl_index++)
  {
      ...
      if ((dp_type == RCiEP) || (dp_type == iEP_EP))
      {
          ...
          /* If RCiEP or iEP_EP supports ACS then it should have AER Capability */
