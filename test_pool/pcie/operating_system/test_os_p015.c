...
#define TEST_RULE  "RE_ACS_1, RE_ACS_2"
#define TEST_DESC  "Check RCiEP P2P Supp                  "
...
payload(void)
{
  ...
  for (tbl_index = 0; tbl_index < bdf_tbl_ptr->num_entries; tbl_index++)
  {
      ...
      if (dp_type == RCiEP)
      {
          ...
          /* If RCiEP supports ACS then it should have AER Capability */
