...
#define TEST_DESC  "B_PPI_01: Check PPI Assignments for OS      "
...
isr_phy()
{
  ...
  val_set_status(0, RESULT_PASS(TEST_NUM, 01));
...
payload()
{
  // Check CNTP interrupt received
  // Check CNTV interrupt received
